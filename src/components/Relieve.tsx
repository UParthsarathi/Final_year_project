        ...
        <div className="glass-panel p-1 flex w-full md:w-auto rounded-full">
          <button
            ...
            className={cn(
              ...
              activeTab === 'breathing' ? "bg-white/10 text-white" : "text-zinc-300 hover:text-zinc-100"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "flex-1 md:flex-none px-6 py-2 rounded-full text-sm font-medium transition-all flex items-center justify-center gap-2",
              activeTab === 'music' ? "bg-white/10 text-white" : "text-zinc-300 hover:text-zinc-100"
            )}
          >
            ...
            <div key={track.id} className="glass-panel p-4 flex items-center gap-4 group hover:bg-white/[0.02] transition-colors cursor-pointer">
              <button 
                ...
                className={cn(
                  ...
                  playingTrack === track.id ? "bg-emerald-500 text-white" : "bg-white/5 text-zinc-300 group-hover:bg-white/10 group-hover:text-white"
                )}
              >
              ...
              <div className="flex-1">
                ...
                <p className="text-zinc-400 text-sm">{track.category}</p>
              </div>
